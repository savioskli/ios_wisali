...
class IntercityPaymentOrderController extends GetxController {
  ...
  getPaymentData() async {
    await FireStoreUtils().getPayment().then((value) {
      if (value != null) {
        ...
        Stripe.merchantIdentifier = 'Wisali';
  ...
  completeOrder() async {
    ...
    WalletTransactionModel adminCommissionWallet = WalletTransactionModel(
        ...
        userType: "driver",
        userId: orderModel.value.driverId.toString(),
        note: "Wisali commission debited".tr);
  ...
  createStripeIntent({required String amount}) async {
    try {
      Map<String, dynamic> body = {
        ...
        "description": "Intercity Ride Payment",
        "shipping[name]": userModel.value.fullName,
        "shipping[address][line1]": "Tannstrasse 24",
        "shipping[address][postal_code]": "8307",
        "shipping[address][city]": "Effretikon",
        "shipping[address][state]": "Effretikon",
        "shipping[address][country]": "Switzerland",
      };
