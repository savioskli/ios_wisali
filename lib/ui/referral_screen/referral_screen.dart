                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  "Earn".tr + ' ${Constant.amountShow(amount: Constant.referralAmount.toString()).tr} ' + "each".tr,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(
                                      ...
                                      Text(
                                        "Invite a friend to sign up using this code and you will get".tr +  
                                        Constant.amountShow(amount: Constant.referralAmount.toString()).tr,
