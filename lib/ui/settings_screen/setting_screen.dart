                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                "Language".tr,
                                                style: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: themeChange.getThem() ? Colors.white : Colors.black),
                                              ),
                                            ),
                                            SizedBox(
                                              ...
                                              child: DropdownButtonFormField(
                                                  ...
                                                  items: controller.languageList.map((item) {
                                                    ...
                                                    return DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item.name.toString(), style: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: themeChange.getThem() ? Colors.white : Colors.black)),
                                                    );
                                                  }).toList()),
                                            ),
                                          ],
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(child: Text("Light/dark mod".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: themeChange.getThem() ? Colors.white : Colors.black))),
                                            SizedBox(
                                              width: Responsive.width(26, context),
                                              child: DropdownButtonFormField<String>(
                                                  ...
                                                  onChanged: (value) {
                                                    ...
                                                    if (controller.selectedMode.value == "Dark mode".tr) {
                                                      themeChange.darkTheme = 0;
                                                    } else if (controller.selectedMode.value == "Light mode".tr) {
                                                  ...
                                                  items: controller.modeList.map((item) {
                                                    return DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item.toString(), style: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: themeChange.getThem() ? Colors.white : Colors.black)),
                                                    );
                                                  }).toList()),
                                            ),
                                          ],
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Support".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: themeChange.getThem() ? Colors.white : Colors.black)),
                                            ],
                                          ),
                                        ),
                                      ),
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Delete Account".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: themeChange.getThem() ? Colors.white : Colors.black))
                                            ],
                                          ),
                                        ),
                                      )
