...
class HomeScreen extends StatelessWidget {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            contactModel.fullName.toString().tr,
                                            style: GoogleFonts.poppins(),
                                          ),
                                        ),
                                        Radio(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            airPortModel.airportName.toString().tr,
                                            style: GoogleFonts.poppins(),
                                          ),
                                        ),
                                        Radio(
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content:  Text("You are not able book new ride please complete previous ride payment".tr),
      actions: [
        okButton,
      ],
    );
